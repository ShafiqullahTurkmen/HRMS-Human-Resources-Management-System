...
public class SkillController {
	...
	public DataResult<List<Skill>> getByCurriculumVitaeId(@RequestParam int curriculumVataeId) {
		return this.skillService.getByCurriculumVitaeId(curriculumVataeId);
	}
